...
<html lang="es">
    ...
    <body style="background-color:#ffffff;">
        ...
        <!-- Barra de navegacion superior -->
            ...
            <div class="row">
                <div class="text-center col-lg-12 mb-6">
                    ...
                    <center>
                        <br><div style="font-size: 34pt">Documento resumen</div><br>
                    </center>
                    ...
                    <?php 
                        ...
                        if (isset($_POST['email']))
                        {
                            ...
                            echo "<td><a class='btn btn-info btn-lg btn-block' href='https://pot.dosquebradas.gov.co/repositorio/POT%20-%20Diciembre%2030%20-%202020/2%20-%20Documento%20resumen/'> Descargar </a></td>";
                            echo "</tr>";
                            echo "<tr class='table-light'>";
                            echo "<td><div style='font-size: 12pt; text-align: left'>POT Municipio de Dosquebradas - Version 30 de Diciembre 2019</div></td>";
                            echo "<td><a class='btn btn-info btn-lg btn-block' href='https://pot.dosquebradas.gov.co/repositorio/POT%20-%20Diciembre%2030%20-%202019/2%20-%20Memoria%20justificativa/'> Descargar </a></td>";
                            echo "</tr>";
                            echo "</table>";
                    ...
                    ?>
                            <div class="row">
                                <div class="col-md-12">
                                    <form name='aporte' role='form' method='post' action='dimension2.php'>
                                        <fieldset>
            ...
            <div class="row">
                ...
                <?php
                    mysqli_query($sle,"SET NAMES 'utf8'");
                    $sql = "SELECT * FROM aportes WHERE dimension = '2' ORDER BY aprobacion DESC";
                        ...
                        <div>
                            <?php
                                if (isset($_GET['id']))
                                {
                                    ...
                                    {
                                        echo "<a class='glyphicon glyphicon-heart-empty' href='dimension2.php?id=$registro[0]'></a>";
                                        echo "<a href='dimension2.php?id=$registro[0]'>Me gusta <span class='badge'>$registro[6]</span></a>";
                                    }
                                }
                                else
                                {
        ...
        <?php 
            ...
            $sql = "UPDATE contador SET d2 = d2 + 1 WHERE id = 1";
            mysqli_query($sle,$sql)or die (mysql_error());
        ?>
