    ...
    <body style="background-color:#ffffff;">
        ...
        <!-- Barra de navegacion superior -->
                ...
                <div class="text-center col-lg-12 mb-6">
                    ...
                    <?php 
                        ...
                        if (isset($_POST['email']))
                        {
                            ...
                            $idea = $_POST['idea'];
                            $sql = "INSERT INTO aportes (dimension, nombre, email, diagnostico, idea, aprobacion) VALUES ('1', '$nombre', '$email', '$problema', '$idea','0')";
                    ...
                    ?>
                            <div class="row">
                                <div class="col-md-12">
                                    <form name='aporte' role='form' method='post' action='dimension1.php'>
                                        <fieldset>
            ...
            <div class="row">
                ...
                <?php
                    mysqli_query($sle,"SET NAMES 'utf8'");
                    $sql = "SELECT * FROM aportes WHERE dimension = '1' ORDER BY aprobacion DESC";
                        ...
                        <div>
                            <?php
                                if (isset($_GET['id']))
                                {
                                    ...
                                    {
                                        echo "<a class='glyphicon glyphicon-heart-empty' href='dimension1.php?id=$registro[0]'></a>";
                                        echo "<a href='dimension1.php?id=$registro[0]'>Me gusta <span class='badge'>$registro[6]</span></a>";
                                    }
                                }
                                else
                                {
        ...
        <?php 
            ...
            $sql = "UPDATE contador SET d1 = d1 + 1 WHERE id = 1";
            mysqli_query($sle,$sql)or die (mysql_error());
        ?>
