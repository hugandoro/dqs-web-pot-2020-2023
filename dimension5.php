...
<html lang="es">
    ...
    <body style="background-color:#ffffff;">
        ...
        <!-- Barra de navegacion superior -->
            ...
            <div class="row">
                <div class="text-center col-lg-12 mb-6">
                    <center>
                        <br><div style="font-size: 34pt">Cartografia</div><br>
                    </center>
                    ...
                    <?php 
                        ...
                        if (isset($_POST['email']))
                        {
                            ...
                            $idea = $_POST['idea'];
                            $sql = "INSERT INTO aportes (dimension, nombre, email, diagnostico, idea, aprobacion) VALUES ('5', '$nombre', '$email', '$problema', '$idea','0')";
                            mysqli_query($sle,$sql)or die (mysql_error());

                            echo "<center><picture><img class='img-responsive' src='images/banner5.jpg'></picture></center>";
                            ...
                            echo "<td><a class='btn btn-info btn-lg btn-block' href='https://pot.dosquebradas.gov.co/repositorio/POT%20-%20Diciembre%2030%20-%202020/6%20-%20Cartografia/'> Descargar </a></td>";
                            echo "</tr>";
                            echo "<tr class='table-light'>";
                            echo "<td><div style='font-size: 12pt; text-align: left'>POT Municipio de Dosquebradas - Version 30 de Diciembre 2019</div></td>";
                            echo "<td><a class='btn btn-info btn-lg btn-block' href='https://pot.dosquebradas.gov.co/repositorio/POT%20-%20Diciembre%2030%20-%202019/5%20-%20Mapas/'> Descargar </a></td>";
                            echo "</tr>";
                            echo "</table>";
                    ...
                    ?>
                            <div class="row">
                                <div class="col-md-12">
                                    <form name='aporte' role='form' method='post' action='dimension5.php'>
                                        <fieldset>
                    ...
                    <?php
                        ...
                        elseif (isset($_GET['id']))
                        {
                            ...
                            if(mysqli_num_rows($sle,$result)==0)
                            {
                                $id = $_GET['id'];
            ...
            <div class="row">
                ...
                <?php
                    mysqli_query($sle,"SET NAMES 'utf8'");
                    $sql = "SELECT * FROM aportes WHERE dimension = '5' ORDER BY aprobacion DESC";
                        ...
                        <div>
                            <?php
                                if (isset($_GET['id']))
                                {
                                    ...
                                    {
                                        echo "<a class='glyphicon glyphicon-heart-empty' href='dimension5.php?id=$registro[0]'></a>";
                                        echo "<a href='dimension5.php?id=$registro[0]'>Me gusta <span class='badge'>$registro[6]</span></a>";
                                    }
                                }
                                else
                                {
        ...
        <?php 
            ...
            $sql = "UPDATE contador SET d5 = d5 + 1 WHERE id = 1";
            mysqli_query($sle,$sql)or die (mysql_error());
        ?>        
