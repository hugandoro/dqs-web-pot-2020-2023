            ...
            <div class="row">
                <div class="text-center col-lg-12 mb-6">
                    <center>
                        <table>
                        <tr>
                            <td><h1 class="display-4">Documento tecnico | </h1></td>
                            <td><a href="/repositorio/4 - DTS Documento Tecnico de Soporte.pdf"><img class='img-responsive' src="images/icono-pdf.png" width="40px"></a></td>
                        </tr>
                        </table>
                    </center>
                    ...
                    <?php 
                        ...
                        if (isset($_POST['email']))
                        {
                            ...
                            $idea = $_POST['idea'];
                            $sql = "INSERT INTO aportes (dimension, nombre, email, diagnostico, idea, aprobacion) VALUES ('4', '$nombre', '$email', '$problema', '$idea','0')";
